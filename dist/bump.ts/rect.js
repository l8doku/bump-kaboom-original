...
export function rect_getNearestCorner(x, y, w, h, px, py) {
...
export function rect_getSegmentIntersectionIndices(x, y, w, h, x1, y1, x2, y2, ti1, ti2) {
...
export function rect_getDiff(x1, y1, w1, h1, x2, y2, w2, h2) {
    return {
        x: x2 - x1 - w1,
        y: y2 - y1 - h1,
        w: w1 + w2,
...
export function rect_containsPoint(x, y, w, h, px, py) {
    return (px - x > DELTA && py - y > DELTA && x + w - px > DELTA && y + h - py > DELTA);
}
export function rect_isIntersecting(x1, y1, w1, h1, x2, y2, w2, h2) {
    return x1 < x2 + w2 && x2 < x1 + w1 && y1 < y2 + h2 && y2 < y1 + h1;
}
export function rect_getSquareDistance(x1, y1, w1, h1, x2, y2, w2, h2) {
    const dx = x1 - x2 + (w1 - w2) / 2;
    const dy = y1 - y2 + (h1 - h2) / 2;
    return dx * dx + dy * dy;
}
export function rect_detectCollision(x1, y1, w1, h1, x2, y2, w2, h2, goalX, goalY) {
